...
Original file is located at
    https://colab.research.google.com/drive/1409N-TrAeVHm5UxCkAtWufHZ9D5W9bIk
...
from os.path import isfile, joinno
...
print("Starting FISH Detections ..")

path = "/content/pexels-taryn-elliott-5548361.mp4"
image = cv2.VideoCapture(path)


#image_width = int(image.get(3))
#image_height = int(image.get(4))

#out = cv2.VideoWriter("video.avi", cv2.VideoWriter_fourcc('M', 'J','P','G'), 10, (image_width,image_height))
